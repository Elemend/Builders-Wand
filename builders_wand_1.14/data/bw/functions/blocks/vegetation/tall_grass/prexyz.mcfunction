...
execute if score @s bw_calc matches 2.. if score #bw_cudu bw_calc matches 1.. if block ~ ~-1 ~ #bw:plantable_on if block ~ ~1 ~ #bw:gothrough run function bw:blocks/vegetation/tall_grass/set
