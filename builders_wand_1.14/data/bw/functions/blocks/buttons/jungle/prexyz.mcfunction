...
execute if score @s bw_calc matches 1.. if score #bw_cudu bw_calc matches 1.. run function bw:blocks/buttons/jungle/collidexyz
execute if score #bw_cdbs bw_calc matches 1 run function bw:blocks/buttons/jungle/set
